 ...
 * and indexed.
 *
 * Seven entries are our own 1080x1920 files under `/videos` (via
 * `web/public/videos` → repo `img/videos`), played by the browser rather than
 * framed by a third party. Nothing is fetched until a card is clicked: the
 * covers are the only bytes this section costs on page load. The eighth is the
 * Vertex 3D tour, which is a navigable app rather than a video and so opens in
 * its own tab.
 *
 ...
 * file in `/videos/covers`.
 *
 * `deploy-layout.mjs` uploads the whole `videos/` tree from the build output.
 *
 * To add a video: drop `<slug>.mp4` in `/videos`, a `<slug>-cover.webp` in
 * `/videos/covers`, add an entry below, and list both paths in
...
export const VIDEO_CARDS: FanCard[] = [
  {
    ...
    imgUrl: '/videos/covers/presentation-projet-cover.webp',
    alt: 'Terrasse en rooftop d’une résidence Emara Estates à Marrakech',
    linkUrl: '/videos/presentation-projet.mp4',
    open: 'modal',
    portrait: true,
  },
  {
    ...
    imgUrl: '/videos/covers/presentation-honest-cover.webp',
    alt: 'Façade d’un programme Honest Signature à Guéliz Marrakech',
    linkUrl: '/videos/presentation-honest.mp4',
    open: 'modal',
    portrait: true,
  },
  {
  ...
  },
  {
    ...
    imgUrl: '/videos/covers/localisation-gueliz-cover.webp',
    alt: 'Vue sur la Koutoubia depuis le quartier Guéliz à Marrakech',
    linkUrl: '/videos/localisation-gueliz.mp4',
    open: 'modal',
    portrait: true,
  },
  {
    ...
    imgUrl: '/videos/covers/lifestyle-cover.webp',
    alt: 'Salle à manger d’un appartement Emara Estates à Marrakech',
    linkUrl: '/videos/lifestyle.mp4',
    open: 'modal',
    portrait: true,
  },
  {
    ...
    imgUrl: '/videos/covers/promoteur-fiable-cover.webp',
    alt: 'Présentation des plans d’un programme immobilier Emara Estates',
    linkUrl: '/videos/promoteur-fiable.mp4',
    open: 'modal',
    portrait: true,
  },
  {
    ...
    imgUrl: '/videos/covers/rendement-locatif-cover.webp',
    alt: 'Piscine et espaces communs d’une résidence à Guéliz Marrakech',
    linkUrl: '/videos/rendement-locatif.mp4',
    open: 'modal',
    portrait: true,
  },
  {
